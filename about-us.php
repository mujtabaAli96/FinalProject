                        ...
                        <div class="row">
                            <div class="col-lg-2 col-md-2 col-sm-5 col-5">
                                ...
                                <div class="sticky-logo">
                                    <a href="index.php"><img src="https://freepngimg.com/thumb/watch/11-2-watch-png-pic.png" alt="" width="80px" height="80px" /></a>
                                </div>
            ...
            <div class="banner-area hm-4-padding">
                <div class="container-fluid">
                    <div class="banner-img">
                        <a href="#"><img src="assets/img/banner/about_banner.jpg" alt=""></a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6 col-12">
                            <div class="team-wrapper mb-30">
                                <div class="team-img">
                                    <img src="assets/img/team/sir_ali.jpg" alt="" height="340px" width="310px">
                                </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-12">
                            <div class="team-wrapper mb-30">
                                <div class="team-img">
                                    <img src="assets/img/team/mujtaba2.png" alt="" height="340px" width="310px">
                                </div>
                                <div class="team-content">
                                    <h4>Mujtaba Ali</h4>
                                    <span>Manager </span>
