    ...
    if (!preg_match("/[a-zA-Z0-9]+/", $pro_title) || strlen($pro_title) < 2) {
        ...
        if (!in_array($image_extension, $allowed_image_extension)) {
            ...
            if (move_uploaded_file($pro_image_tmp, $target)) {
                ...
                $insert_product = "insert into products (pro_title,pro_price,pro_desc,pro_keywords,pro_image) 
                  VALUES ('$pro_title','$pro_price','$pro_desc','$pro_keywords','$updated_img_name');";
