                        ...
                        <div class="row">
                            <div class="col-lg-2 col-md-2 col-sm-5 col-5">
                                ...
                                <div class="sticky-logo">
                                    <a href="index.php"><img src="https://freepngimg.com/thumb/watch/11-2-watch-png-pic.png"" width="100px" height="100px" alt="" /></a>
                                </div>
                                <div class="logo-small-device">
                                    <a href="index.php"><img alt="" src="https://freepngimg.com/thumb/watch/11-2-watch-png-pic.png" width="100px" height="100px" alt="" width="100px"></a>
                                </div>
                            </div>
                            <div class="col-lg-8 col-md-8 d-none d-md-block">
                                <div class="logo-menu-wrapper text-center">
                                    <div class="logo">
                                        <a href="index.php"><img src="http://www.pngmart.com/files/3/Wall-Watch-PNG-File.png" width="100px" height="100px" alt="" /></a>
                                    </div>
                                    <div class="main-menu">
                                        <nav>
                                            <ul>
                        ...
                        <div class="col-lg-4 col-xl-3">
                            <div class="blog-sidebar-wrapper sidebar-mrg2 pr-20">
                                ...
                                <div class="blog-widget mb-65">
                                    <h4 class="blog-widget-title mb-35">RECENT POST</h4>
                            ...
                            <div class="blog-wrapper">
                                <div class="single-blog-wrapper mb-80">
                                    ...
                                    <div class="blog-content">
                                        <h2><a href="blog-details-standerd.php">Spirit of Adventure Rises</a></h2>
                                    ...
                                    <div class="blog-btn-social mt-20">
                                        <div class="blog-btn">
                                            <a class="btn-style cr-btn" href="blog-details-standerd.php">
                                                <span>read more</span>
                                            </a>
                                        </div>
                                ...
                                <div class="single-blog-wrapper mb-80">
                                    ...
                                    <div class="blog-content">
                                        <h2><a href="blog-details-audio.php">Spirit of Adventure Rises</a></h2>
                                        <div class="blog-date-categori">
                                            <ul>
                                                <li>October 14, 2018 </li>
                                                <li><a href="#">Admin </a></li>
                                ...
                                <div class="single-blog-wrapper mb-80">
                                    ...
                                    <div class="blog-content">
                                        <h2><a href="blog-details-gallery.php">Spirit of Adventure Rises</a></h2>
                                        <div class="blog-date-categori">
                                            <ul>
                                                <li>October 14, 2018 </li>
                                                <li><a href="#">Admin </a></li>
