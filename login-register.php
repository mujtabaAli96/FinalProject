...
if(isset($_POST['login'])){
    ...
    $sel_user = "select * from customers where cust_email='$email' AND cust_pass='$pass'";
            ...
            <div class="banner-area hm-4-padding">
                <div class="container-fluid">
                    <div class="banner-img">
                        <a href="#"><img src="assets/img/banner/certina.jpg" alt=""></a>
                    </div>
                </div>
            </div>
                                    ...
                                    <div id="lg1" class="tab-pane active">
                                        <div class="login-form-container">
                                            <div class="login-form">
                                                <form action="login-register.php" method="post" class="login_form">
                                                     <h2 class="text-danger"><?php echo @$_GET['not_admin']?></h2>
        <h2 class="text-primary"><?php echo @$_GET['logged_out']?></h2>
        <h3 class="m-3">Admin Login </h3>
        <div><?php echo $error_msg;?></div>
                                        ...
                                        <div class="login-form-container">
                                            <div class="login-form">
                                                <form action="registration.php" method="post">
                                                    <input type="text" name="user_name2" id="user_name2" placeholder="Name" pattern="..+" required>
                                                     <input name="user_email2" placeholder="Email" type="email" required>
                                                    <input type="password" name="user_password2" placeholder="Password" pattern="...+" required>
